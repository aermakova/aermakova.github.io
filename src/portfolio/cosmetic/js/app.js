$(function () {
	...
	if (blocks.serviceList.length) {
		blocks.serviceList.slick({
			slidesToShow: 4,
			slidesToScroll: 1,
			infinite: true,
			autoplay: true,
		...
		blocks.serviceList.slick('slickPause');
		blocks.serviceList.waypoint({
			offset: 500,
			handler: function () {
				$(this.element).slick('slickPlay');
				this.destroy();
...
ymaps.ready(function () {
    ...
    if (el != null) {  
        ...
        var myMap = new ymaps.Map('map', {
                center: [55.35142049, 86.10894242],
                zoom: 14.5,
                controls: []
            }, {
            ...
            myPlacemark = new ymaps.Placemark([55.35142049, 86.10894242], {
                hintContent: 'Улица, номер дома',
                balloonContent: 'Название компании'
            }, {
                // Опции.
